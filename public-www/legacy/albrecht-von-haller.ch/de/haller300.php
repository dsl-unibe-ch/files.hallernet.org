...
<div id="schrift"><a href="javascript:chooseStyle('none', 60)" style="font-size: 9px">A</a> | <a href="javascript:chooseStyle('pbig', 60)" style="font-size: 12px">A</a> | <a href="javascript:chooseStyle('pbiger', 60)" style="font-size: 14px">A</a></div>
  <div id="content">
    <p>Unter dem Motto Haller300 organisierte die Albrecht von  Haller-Stiftung der Burgergemeinde Bern zusammen mit der Universit&auml;t  Bern und weiteren Partnern anl&auml;sslich von Hallers 300. Geburtstag 2008  eine Reihe von &uuml;ber 100 Veranstaltungen, in denen Haller einem breiten  Publikum als paradigmatische Figur zwischen Ancien R&eacute;gime und moderner  Wissenschaft pr&auml;sentiert wurde:</p>
<ul class="einzug">
    <li>eine Jubil&auml;umsfeier</li>
    <li>zwei Ausstellungen</li>
    <li>eine neue Theaterproduktion</li>
    <li>Haller zu Gast bei der Museumsnacht Bern 2008</li>
    <li>zwei wissenschaftliche Kongresse</li>
    <li>Buchpublikationen</li>
    <li>Begleitveranstaltungen wie Stadtf&uuml;hrungen, Alpenwanderungen,  Lesungen etc.</li>
</ul>
<p>Anhand von Programmheft, Pressespiegel, Radio-und Fernsehberichten  k&ouml;nnen Sie das Haller-Jahr Revue passieren lassen.</p>     </div>

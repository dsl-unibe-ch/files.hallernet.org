...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
<title>Forschungsliteratur - Albrecht von Haller</title>
...
<div id="contenttitel">Forschungsliteratur</div>
</div>
...
<li class="LNE_menu"><a class="selected" href="forschungsliteratur.php">Forschungsliteratur</a></li>
<li class="LNE_menu_intend"><a href="bis2004.php">bis 2004</a></li>
<li class="LNE_menu_intend"><a href="ab2005.php">ab 2005</a></li>
...
<div id="schrift"><a href="javascript:chooseStyle('none', 60)" style="font-size: 9px">A</a> | <a href="javascript:chooseStyle('pbig', 60)" style="font-size: 12px">A</a> | <a href="javascript:chooseStyle('pbiger', 60)" style="font-size: 14px">A</a></div>
  <div id="content">
    <p>Hier sind die auf der Website erw&auml;hnte Forschungsliteratur sowie der Nachtrag zur Bibliographia Halleriana (Steinke/Profos 2004) verzeichnet. Aufgef&uuml;hrt ist zudem die im Netz direkt greifbare Literatur. <br />
Letzte Aktualisierung: 15.1.2011<br />
Hinweise auf fehlende Literatur bitte an <a href="mailto:martin.stuber@hist.unibe.ch">Martin Stuber</a>.<a href="#nachtrag"><br />
</a></p>
<p>&nbsp;</p>
     </div>
<div id="footer">Eine Website der Albrecht von Haller-Stiftung der Burgergemeinde Bern,<br />des Historischen Instituts der Universität Bern und des Instituts für Medizingeschichte der Universität Bern <br />Konzept und Inhalt: Hubert Steinke, Martin Stuber | Webdesign: <a href="http://www.hannessaxer.ch/website/index.php">Hannes Saxer</a> | <a href="./LightNEasy.php?do=login">Login</a> | <a href="forschungsliteratur.php?do=sitemap">Sitemap</a></div>
</div>
<div id="annex">
 <p class="haller"></p>
</div>

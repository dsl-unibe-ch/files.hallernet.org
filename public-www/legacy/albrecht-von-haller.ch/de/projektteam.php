...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
<title>Projektteam - Albrecht von Haller</title>
...
<div id="contenttitel">Projektteam</div>
</div>
...
<li class="LNE_menu_doubleintend"><a class="selected" href="projektteam.php">Projektteam</a></li>
...
<div id="schrift"><a href="javascript:chooseStyle('none', 60)" style="font-size: 9px">A</a> | <a href="javascript:chooseStyle('pbig', 60)" style="font-size: 12px">A</a> | <a href="javascript:chooseStyle('pbiger', 60)" style="font-size: 14px">A</a></div>
  <div id="content">
    <p>Georg von Erlach, Koordinator&nbsp;</p>
<p>J. Harald W&auml;ber (Pr&auml;sident der Albrecht von Haller Stiftung der Burgergemeinde Bern)&nbsp;</p>
<p>Prof. Dr. Urs Boschung (Institut f&uuml;r Medizingeschichte, Universit&auml;t Bern)&nbsp;</p>
<p>Dr. Barbara Braun (Burgerbibliothek Bern)&nbsp;</p>
<p>Marisa Cossi, Protokoll&nbsp;</p>
<p>Prof. Dr. Andr&eacute; Holenstein (Historisches Institut, Universit&auml;t Bern)&nbsp;</p>
<p>Luc Lienhard (Botaniker, Biel)&nbsp;</p>
<p>Dr. Dr. Hubert Steinke (Institut f&uuml;r Medizingeschichte, Universit&auml;t Bern)&nbsp;</p>
<p>Dr. Martin Stuber (Historisches Institut, Universit&auml;t Bern)</p>     </div>
<div id="footer">Eine Website der Albrecht von Haller-Stiftung der Burgergemeinde Bern,<br />des Historischen Instituts der Universität Bern und des Instituts für Medizingeschichte der Universität Bern <br />Konzept und Inhalt: Hubert Steinke, Martin Stuber | Webdesign: <a href="http://www.hannessaxer.ch/website/index.php">Hannes Saxer</a> | <a href="./LightNEasy.php?do=login">Login</a> | <a href="projektteam.php?do=sitemap">Sitemap</a></div>
</div>
<div id="annex">
 <p class="haller"></p>
</div>

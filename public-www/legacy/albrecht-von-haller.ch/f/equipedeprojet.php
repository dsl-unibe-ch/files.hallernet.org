...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
<title>Equipe de projet - Albrecht von Haller</title>
...
<div id="contenttitel">Equipe de projet</div>
</div>
...
<li class="LNE_menu_doubleintend"><a class="selected" href="equipedeprojet.php">Equipe de projet</a></li>
...
<div id="schrift"><a href="javascript:chooseStyle('none', 60)" style="font-size: 9px">A</a> | <a href="javascript:chooseStyle('pbig', 60)" style="font-size: 12px">A</a> | <a href="javascript:chooseStyle('pbiger', 60)" style="font-size: 14px">A</a></div>
  <div id="content">
    <p>Georg von Erlach, coordinateur</p>
<p>J. Harald W&auml;ber (Pr&eacute;sident de la Fondation Albrecht von Haller de la</p>
<p>Commune Bourgeoise de Berne)</p>
<p>Urs Boschung (Institut d'histoire de la m&eacute;decine, Universit&eacute; de Berne)</p>
<p>Dr. Barbara Braun-Bucher (Biblioth&egrave;que de la Bourgeoisie de Berne)</p>
<p>Marisa Cossi, protocole</p>
<p>Andr&eacute; Holenstein (Institut d'histoire, Universit&eacute; de Berne)</p>
<p>Luc Lienhard (botaniste, Bienne)</p>
<p>Hubert Steinke (Institut d'histoire de la m&eacute;decine, Universit&eacute; de Berne)</p>
<p>Martin Stuber (Institut d'histoire, Universit&eacute; de Berne)</p>     </div>
<div id="footer">Un site web de la Fondation Albrecht von Haller de la Bourgeoisie de Berne, <br />de l'Institut d'Histoire et de l'Institut d'Histoire de la Médecine de l'Université de Berne <br />Concept and content: Hubert Steinke, Martin Stuber | Webdesign: <a href="http://www.hannessaxer.ch/website/index.php">Hannes Saxer</a> | <a href="./LightNEasy.php?do=login">Login</a> | <a href="equipedeprojet.php?do=sitemap">Sitemap</a></div>
</div>
<div id="annex">
 <p class="haller"></p>
</div>

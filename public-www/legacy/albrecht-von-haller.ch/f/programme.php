...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
<title>Programme - Albrecht von Haller</title>
...
<div id="contenttitel">Programme</div>
</div>
...
<li class="LNE_menu_doubleintend"><a class="selected" href="programme.php">Programme</a></li>
...
<div id="schrift"><a href="javascript:chooseStyle('none', 60)" style="font-size: 9px">A</a> | <a href="javascript:chooseStyle('pbig', 60)" style="font-size: 12px">A</a> | <a href="javascript:chooseStyle('pbiger', 60)" style="font-size: 14px">A</a></div>
  <div id="content">
    <div style="background-image: url(&quot;templates/basisdesign/bg-programm.jpg&quot;);" class="bildlink">
<div class="textdiv">
<h2>Programme Haller 300</h2>
</div>
<div class="buttondiv"><a class="button" title="Programme" href="/avh/f/images/file/haller300-f.pdf"> Download&raquo;</a></div>
</div>
<p>&nbsp;</p>     </div>
<div id="footer">Un site web de la Fondation Albrecht von Haller de la Bourgeoisie de Berne, <br />de l'Institut d'Histoire et de l'Institut d'Histoire de la Médecine de l'Université de Berne <br />Concept and content: Hubert Steinke, Martin Stuber | Webdesign: <a href="http://www.hannessaxer.ch/website/index.php">Hannes Saxer</a> | <a href="./LightNEasy.php?do=login">Login</a> | <a href="programme.php?do=sitemap">Sitemap</a></div>
</div>
<div id="annex">
 <p class="haller"></p>
</div>

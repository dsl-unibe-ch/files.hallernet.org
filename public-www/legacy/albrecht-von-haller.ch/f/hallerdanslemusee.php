...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
<title>Haller dans le musée - Albrecht von Haller</title>
...
<div id="contenttitel">Haller dans le musée</div>
</div>
...
<li class="LNE_menu_intend"><a class="selected" href="hallerdanslemusee.php">Haller dans le musée</a></li>
...
<div id="schrift"><a href="javascript:chooseStyle('none', 60)" style="font-size: 9px">A</a> | <a href="javascript:chooseStyle('pbig', 60)" style="font-size: 12px">A</a> | <a href="javascript:chooseStyle('pbiger', 60)" style="font-size: 14px">A</a></div>
  <div id="content">
    <p><img width="240" height="344" src="/d/images/plakat.jpg" alt="" /></p>
<p>Bas&eacute; sur l&rsquo;exposition <a href="http://www.bhm.ch/fr/expositions/archives/albrecht-von-haller-1708-1777-le-grand-savant-suisse/" target="_blank">&bdquo;Albrecht von Haller (1708&ndash;1777) - Le grand savant suisse&ldquo;</a> dans le Mus&eacute;e Historique de Berne, 4 d&eacute;cembre 2008 &ndash; 14 avril 2009 .</p>
<p><a href="http://www.albrecht-von-haller.ch/haller_im_museum/index_f.htm" class="button" title="Titel">voir &raquo; </a></p>     </div>
<div id="footer">Un site web de la Fondation Albrecht von Haller de la Bourgeoisie de Berne, <br />de l'Institut d'Histoire et de l'Institut d'Histoire de la Médecine de l'Université de Berne <br />Concept and content: Hubert Steinke, Martin Stuber | Webdesign: <a href="http://www.hannessaxer.ch/website/index.php">Hannes Saxer</a> | <a href="./LightNEasy.php?do=login">Login</a> | <a href="hallerdanslemusee.php?do=sitemap">Sitemap</a></div>
</div>
<div id="annex">
 <p class="haller"></p>
</div>

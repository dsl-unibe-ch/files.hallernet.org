...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
<title>Littérature secondaire - Albrecht von Haller</title>
...
<div id="contenttitel">Littérature secondaire</div>
</div>
...
<li class="LNE_menu"><a class="selected" href="litteraturesecondaire.php">Littérature secondaire</a></li>
<li class="LNE_menu_intend"><a href="bis2004.php">jusqu’en 2004</a></li>
<li class="LNE_menu_intend"><a href="ab2005.php">depuis 2005</a></li>
...
<div id="schrift"><a href="javascript:chooseStyle('none', 60)" style="font-size: 9px">A</a> | <a href="javascript:chooseStyle('pbig', 60)" style="font-size: 12px">A</a> | <a href="javascript:chooseStyle('pbiger', 60)" style="font-size: 14px">A</a></div>
  <div id="content">
    <p>Vous trouverez ici la totalit&eacute; des r&eacute;f&eacute;rences litt&eacute;raires mentionn&eacute;es sur ce site, y compris le suppl&eacute;ment &agrave; la Bibliographia Halleriana (Steinke/Profos 2004). Nous indiquons en outre la litt&eacute;rature consultable directement en ligne.<br />
Derni&egrave;re mise &agrave; jour: 15.1.2011<br />
Nous vous serions reconnaissant d&rsquo;indiquer toute litt&eacute;rature manquante &agrave; <a href="mailto:martin.stuber@hist.unibe.ch">Martin Stuber</a>.</p>     </div>
<div id="footer">Un site web de la Fondation Albrecht von Haller de la Bourgeoisie de Berne, <br />de l'Institut d'Histoire et de l'Institut d'Histoire de la Médecine de l'Université de Berne <br />Concept and content: Hubert Steinke, Martin Stuber | Webdesign: <a href="http://www.hannessaxer.ch/website/index.php">Hannes Saxer</a> | <a href="./LightNEasy.php?do=login">Login</a> | <a href="litteraturesecondaire.php?do=sitemap">Sitemap</a></div>
</div>
<div id="annex">
 <p class="haller"></p>
</div>

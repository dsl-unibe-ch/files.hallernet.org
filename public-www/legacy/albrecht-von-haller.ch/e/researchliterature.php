...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
<title>Research literature - Albrecht von Haller</title>
...
<div id="contenttitel">Research literature</div>
</div>
...
<li class="LNE_menu"><a class="selected" href="researchliterature.php">Research literature</a></li>
<li class="LNE_menu_intend"><a href="bis2004.php">Up to 2004</a></li>
...
<div id="schrift"><a href="javascript:chooseStyle('none', 60)" style="font-size: 9px">A</a> | <a href="javascript:chooseStyle('pbig', 60)" style="font-size: 12px">A</a> | <a href="javascript:chooseStyle('pbiger', 60)" style="font-size: 14px">A</a></div>
  <div id="content">
    <p>This page contains an index of research literature mentioned on the website and a list of additions to the Bibliographia Halleriana (<a href="ab2005.php#SteinkeProfos2004">Steinke/Profos 2004</a>). Literature directly available online is listed as well.<br />
Last updated: 15. january 2011<br />
Please direct comments about missing literature to <a href="mailto:martin.stuber@hist.unibe.ch">Martin Stuber</a>.</p>     </div>
<div id="footer">A website of the Albrecht von Haller Foundation of the Burgergemeinde Bern,<br />the Institute of History and the Institute of History of Medicine of the University of Bern<br /> Concept and content: Hubert Steinke, Martin Stuber | Webdesign: <a href="http://www.hannessaxer.ch/website/index.php">Hannes Saxer</a> | <a href="./LightNEasy.php?do=login">Login</a> | <a href="researchliterature.php?do=sitemap">Sitemap</a></div>
</div>
<div id="annex">
 <p class="haller"></p>
</div>

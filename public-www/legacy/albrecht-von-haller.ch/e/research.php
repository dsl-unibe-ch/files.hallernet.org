...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
<title>Research - Albrecht von Haller</title>
...
<div id="contenttitel">Research</div>
</div>
...
<li class="LNE_menu"><a class="selected" href="research.php">Research</a></li>
...
<div id="schrift"><a href="javascript:chooseStyle('none', 60)" style="font-size: 9px">A</a> | <a href="javascript:chooseStyle('pbig', 60)" style="font-size: 12px">A</a> | <a href="javascript:chooseStyle('pbiger', 60)" style="font-size: 14px">A</a></div>
  <div id="content">
    <p>Haller&rsquo;s great influence in different areas of science, society, and culture, his innumerable publications, and the rich body of handwritten documents that he left at his death have inspired many different studies. Nevertheless, the existing research on Haller is far from exhaustive. The reason for this can be found in the extent of his works and in the multifaceted nature of both his character and his influence. Doing research on Haller continues to mean traversing difficult terrain. </p>
<p>These difficulties, however, constitute an argument in favour of, rather than against, greater commitment to Haller. For behind these difficulties lies the multifaceted and contradictory nature of the century of the Enlightenment, which is no less characteristic of this era than its more clearly defined programmes and lines of development. This has been demonstrated, in particular, by the results of recent research on the Enlightenment, which has been concerned increasingly with the interrelationships among different areas of life as well as with differences determined by the historical, economic, political, geographical, and confessional conditions of the 18th Century. Such studies have not only examined specific topics and ideologies, but have also looked more closely at the structures and practices that facilitated and helped to shape scientific, cultural, and economic life.</p>
<p>Haller exemplifies the extreme abundance of material that can be drawn on to address these issues. Not only did his life and work take place in different geographical regions (Bern, Göttingen), within different structures (university, republic of letters, administration), and on different levels (doctor, poet, scientist, magistrate); they have also been documented with extraordinary comprehensiveness and precision. Innumerable letters, files, handwritten documents, and publications permit a view of the foreground and the background, the processes and structures, the ideas and ideologies, and the statics and dynamics of the 18th Century. </p>
<p>Today the conditions are favourable for in-depth studies of Haller. Several basic studies of his thought, his poetry, and his contributions to medicine, as well as edited editions of several important exchanges of letters, have elevated research on Haller to a new level in recent decades. Literature by and about Haller, as well as his entire network of correspondence, have been indexed and analysed as part of the so-called &ldquo;Haller Project&rdquo; in Bern. Access to Haller is also facilitated by a databank that contains a large and continually growing amount of textual material and information. </p>     </div>
<div id="footer">A website of the Albrecht von Haller Foundation of the Burgergemeinde Bern,<br />the Institute of History and the Institute of History of Medicine of the University of Bern<br /> Concept and content: Hubert Steinke, Martin Stuber | Webdesign: <a href="http://www.hannessaxer.ch/website/index.php">Hannes Saxer</a> | <a href="./LightNEasy.php?do=login">Login</a> | <a href="research.php?do=sitemap">Sitemap</a></div>
</div>
<div id="annex">
 <p class="haller"></p>
</div>

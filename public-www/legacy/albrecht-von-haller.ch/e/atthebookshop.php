...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
<title>At the bookshop - Albrecht von Haller</title>
...
<div id="contenttitel">At the bookshop</div>
</div>
...
<li class="LNE_menu"><a class="selected" href="atthebookshop.php">At the bookshop</a></li>
...
<div id="schrift"><a href="javascript:chooseStyle('none', 60)" style="font-size: 9px">A</a> | <a href="javascript:chooseStyle('pbig', 60)" style="font-size: 12px">A</a> | <a href="javascript:chooseStyle('pbiger', 60)" style="font-size: 14px">A</a></div>
  <div id="content">
    <div id="buchhandel">
<div id="allesprachen">&nbsp;</div>
<p>
<script>
$('#allesprachen').load('../d/imbuchhandel.php #allesprachen > *', function() {

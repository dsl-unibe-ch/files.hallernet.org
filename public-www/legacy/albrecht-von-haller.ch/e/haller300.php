...
<div id="schrift"><a href="javascript:chooseStyle('none', 60)" style="font-size: 9px">A</a> | <a href="javascript:chooseStyle('pbig', 60)" style="font-size: 12px">A</a> | <a href="javascript:chooseStyle('pbiger', 60)" style="font-size: 14px">A</a></div>
  <div id="content">
    <p>Under the motto &ldquo;Haller 300&rdquo;, in commemoration of the 300th anniversary of Haller&rsquo;s birth in 2008, the Albrecht von Haller Foundation of the Burgergemeinde Bern, in cooperation with the University of Bern and additional partners, organised a series of over 100 events in which Haller was presented to a broad public as a paradigmatic figure between the Ancien R&eacute;gime and the age of modern science. These events included:</p>
<ul class="einzug">
    <li>An anniversary celebration</li>
    <li>Two exhibitions</li>
    <li>A new stage production</li>
    <li>Haller as a guest at Bern&rsquo;s Museums Night in 2008</li>
    <li>Two academic conferences</li>
    <li>Book publications</li>
    <li>Additional events such as city tours, Alpine hikes, public lectures, etc.</li>
</ul>
<p>The programme for &ldquo;Haller 300&rdquo; and a collection of press reviews and radio and television reports offer an opportunity to review the events of the Haller 300 commemorative year.</p>
<p>&nbsp;</p>     </div>

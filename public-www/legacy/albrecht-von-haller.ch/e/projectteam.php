...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
<title>Project team - Albrecht von Haller</title>
...
<div id="contenttitel">Project team</div>
</div>
...
<li class="LNE_menu_doubleintend"><a class="selected" href="projectteam.php">Project team</a></li>
...
<div id="schrift"><a href="javascript:chooseStyle('none', 60)" style="font-size: 9px">A</a> | <a href="javascript:chooseStyle('pbig', 60)" style="font-size: 12px">A</a> | <a href="javascript:chooseStyle('pbiger', 60)" style="font-size: 14px">A</a></div>
  <div id="content">
    <p>Georg von Erlach, coordinator</p>
<p>J. Harald W&auml;ber (President of the Albrecht von Haller Stiftung der Burgergemeinde Bern)</p>
<p>Prof. Dr. Urs Boschung (Institute for the History of Medicine, University of Bern)</p>
<p>Dr. Barbara Braun-Bucher (Burgerbibliothek Bern)</p>
<p>Marisa Cossi, protocol</p>
<p>Prof. Dr. Andr&eacute; Holenstein (Institute for History, University of Bern)</p>
<p>Luc Lienhard (botanist, Biel)</p>
<p>Dr. Dr. Hubert Steinke (Institute f&uuml;r the History of Medicine, University of Bern)</p>
<p>Dr. Martin Stuber (Institute for History, University of Bern)</p>     </div>
<div id="footer">A website of the Albrecht von Haller Foundation of the Burgergemeinde Bern,<br />the Institute of History and the Institute of History of Medicine of the University of Bern<br /> Concept and content: Hubert Steinke, Martin Stuber | Webdesign: <a href="http://www.hannessaxer.ch/website/index.php">Hannes Saxer</a> | <a href="./LightNEasy.php?do=login">Login</a> | <a href="projectteam.php?do=sitemap">Sitemap</a></div>
</div>
<div id="annex">
 <p class="haller"></p>
</div>

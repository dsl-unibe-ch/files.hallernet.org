...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
<title>Theatre, music, comics (in German) - Albrecht von Haller</title>
...
<div id="contenttitel">Theatre, music, comics (in German)</div>
</div>
...
<li class="LNE_menu_intend"><a href="pictures.php">Pictures</a></li>
<li class="LNE_menu_intend"><a class="selected" href="theatremusiccomics.php">Theatre, music, comics (in German)</a></li>
...
<ul id="link">
    ...
    <a onclick="window.open(this.href,'','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=400,height=100,status'); return false" href="../medien/krneta_greis_apfelboeck/umgekehrti_taeler.mp3">h&ouml;ren</a></li>
</ul>
<p>&nbsp;</p>
<h2>Vertonung</h2>
<ul id="link">
    ...
    <a onclick="window.open(this.href,'','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=400,height=100,status'); return false" href="../medien/steinke_ehrsam/die_alpen/01_die_alpen.mp3">h&ouml;ren</a> &ndash; Ihr Sch&uuml;ler der Natur... (Zeilen 31-40)<br />
    <a onclick="window.open(this.href,'','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=400,height=100,status'); return false" href="../medien/steinke_ehrsam/die_alpen/02_die_alpen.mp3">h&ouml;ren</a> &ndash; Zwar die Natur bedeckt... (Zeilen 51-60)<br />
    <a onclick="window.open(this.href,'','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=400,height=100,status'); return false" href="../medien/steinke_ehrsam/die_alpen/03_die_alpen.mp3">h&ouml;ren</a> &ndash; Hier herrscht kein Unterschied... (Zeilen 71-80)<br />
    <a onclick="window.open(this.href,'','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=400,height=100,status'); return false" href="../medien/steinke_ehrsam/die_alpen/04_die_alpen.mp3">h&ouml;ren</a> &ndash; Hat nun die m&uuml;de Welt... (Zeilen 251-260)<br />
    <a onclick="window.open(this.href,'','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=400,height=100,status'); return false" href="../medien/steinke_ehrsam/die_alpen/05_die_alpen.mp3">h&ouml;ren</a> &ndash; Ein junger Sch&auml;fer... (Zeilen 271-280)<br />
    <a onclick="window.open(this.href,'','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=400,height=100,status'); return false" href="../medien/steinke_ehrsam/die_alpen/06_die_alpen.mp3">h&ouml;ren</a> &ndash; Dann hier, wo Gotthards Haupt... (Zeilen 311-320)<br />
    <a onclick="window.open(this.href,'','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=400,height=100,status'); return false" href="../medien/steinke_ehrsam/die_alpen/07_die_alpen.mp3">h&ouml;ren</a> &ndash; Hier zeigt ein steiler Berg.... (Zeilen 351-360)<br />
    <a onclick="window.open(this.href,'','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=400,height=100,status'); return false" href="../medien/steinke_ehrsam/die_alpen/08_die_alpen.mp3">h&ouml;ren</a> &ndash; Dort ragt das hohe Haupt... (Zeilen 381-390)<br />
    <a onclick="window.open(this.href,'','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=400,height=100,status'); return false" href="../medien/steinke_ehrsam/die_alpen/09_die_alpen.mp3">h&ouml;ren</a> &ndash; Allein wohin auch nie... (Zeilen 401-410)<br />
    <a onclick="window.open(this.href,'','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=400,height=100,status'); return false" href="../medien/steinke_ehrsam/die_alpen/10_die_alpen.mp3">h&ouml;ren</a> &ndash; Aus Schreckhorns kaltem Haupt... (Zeilen 431-440)<br />
    <a onclick="window.open(this.href,'','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=400,height=100,status'); return false" href="../medien/steinke_ehrsam/die_alpen/11_die_alpen.mp3">h&ouml;ren</a>  &ndash; Bei euch, vergn&uuml;gtes Volk... (Zeilen 471-480)<br />
    <a onclick="window.open(this.href,'','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=400,height=100,status'); return false" href="../medien/steinke_ehrsam/die_alpen/12_die_alpen.mp3">h&ouml;ren</a> &ndash; O selig! wer wie Ihr... (Zeilen 481-490)</li>
    <li>Regula Steinke (Mezzosopran) und Gregor Ehrsam (Cembalo)<br />
    ...
    <a onclick="window.open(this.href,'Heuchler','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=400,height=100,status'); return false" href="../medien/steinke_ehrsam/haller_vernissage/der_heuchler.mp3">h&ouml;ren</a></li>
    <li>Regula Steinke (Mezzosopran) und Gregor Ehrsam (Cembalo)<br />
    ...
    <a onclick="window.open(this.href,'AnDoris','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=400,height=100,status'); return false" href="../medien/steinke_ehrsam/haller_vernissage/doris_steffan.mp3">h&ouml;ren</a></li>
    <li>Regula Steinke (Mezzosopran) und Gregor Ehrsam (Cembalo)<br />
    ...
    <a href="../medien/steinke_ehrsam/haller_vernissage/doris_bach.mp3" onclick="window.open(this.href,'Doris','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=400,height=100,status'); return false">h&ouml;ren</a></li>
</ul>
<p>&nbsp;</p>
...
<ul id="link">
    ...
    <a onclick="window.open(this.href,'','resizable=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no,fullscreen=no,dependent=no,width=400,height=100,status'); return false" href="../medien/witschi/die_alpen.mp3">h&ouml;ren</a></li>
</ul>
<p>&nbsp;</p>
<h2>Theater</h2>
<ul id="link">
    <li><strong>&laquo;Ebenda &ndash; Ein Ged&auml;chtnistheater&raquo;</strong>. Projekt von Christian Probst und <a href="http://www.theater.ch/lukasbaerfuss" target="_blank">Lukas B&auml;rfuss</a> zu Albrecht von Haller. Urauff&uuml;hrungsproduktion. Regie: Christoph Probst. Dramaturgie: Lukas B&auml;rfuss. B&uuml;hne: Christoph Wagenknecht. Musik: Simon Hostettler. Mit Matthias Brambeer, Doro Mueggler, <a href="http://www.theater.ch/andrischenardi" target="_blank">Andri Schenardi</a>, Marcus Signer, Ernst C. Sigrist, <a href="http://www.theater.ch/diegovalsecchi" target="_blank">Diego Valsecchi</a>. Produktion: <a href="http://www.theater.ch/stadttheater.bern" target="_blank">Stadttheater Bern</a>.</li>
</ul>
...
<p>&nbsp;</p>
<h2>Comic</h2>
<div class="bildlink" style="background-image: url(&quot;templates/basisdesign/bg-comic.jpg&quot;);">
<div class="textdiv">
<h2>Entwurf zu vier Bildergeschichten</h2>
<p>Konzept und Ausf&uuml;hrung: Roland de Loriol, Bern</p>
</div>
<div class="buttondiv"><a class="button" title="Comic.jpg" rel="lytebox[galeries/Comic]" href="galeries/Comic/Comic01.jpg">Episode 1: Lebendversuche &raquo; </a>
...
<a class="button" title="Comic.jpg" rel="lytebox[galeries/Comicplot]" href="galeries/Comicplot/Comicplot01.jpg">Entw&uuml;rfe zu drei weiteren Episoden &raquo; </a>

...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
<title>Program - Albrecht von Haller</title>
...
<div id="contenttitel">Program</div>
</div>
...
<li class="LNE_menu_doubleintend"><a class="selected" href="program.php">Program</a></li>
...
<div id="schrift"><a href="javascript:chooseStyle('none', 60)" style="font-size: 9px">A</a> | <a href="javascript:chooseStyle('pbig', 60)" style="font-size: 12px">A</a> | <a href="javascript:chooseStyle('pbiger', 60)" style="font-size: 14px">A</a></div>
  <div id="content">
    <div class="bildlink" style="background-image: url(&quot;templates/basisdesign/bg-programm.jpg&quot;);">
<div class="textdiv">
<h2>Program (in German)</h2>
</div>
<div class="buttondiv"><a class="button" title="Programmheft" href="../medien/pdf/haller300-d.pdf">Download PDF &raquo; </a></div>
</div>     </div>
<div id="footer">A website of the Albrecht von Haller Foundation of the Burgergemeinde Bern,<br />the Institute of History and the Institute of History of Medicine of the University of Bern<br /> Concept and content: Hubert Steinke, Martin Stuber | Webdesign: <a href="http://www.hannessaxer.ch/website/index.php">Hannes Saxer</a> | <a href="./LightNEasy.php?do=login">Login</a> | <a href="program.php?do=sitemap">Sitemap</a></div>
</div>
<div id="annex">
 <p class="haller"></p>
</div>
